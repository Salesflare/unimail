 ...
 * @property {Object} addresses - Object representing the from and to email addresses of the message that contains the file
 ...
 * @property {FileResource[]} files - Array of files in the message
 */
