...
class NylasConnector extends EventEmitter {
     ...
     *
     * @param {function(Error?, (Object | String)?):void} callback Returns a unified message resource when options.raw is falsy or the raw response of the API when truthy
     * @returns {void}
     */
     ...
     * @param {Object} options
     * @param {Boolean} [options.raw] - If true the response will not be transformed to the unified object
     * @param {function(Error?, { messages: Array.<Object | String>, next_page_token: String? }?):void} callback Returns an array of unified message resources when options.raw is falsy or the raw response of the API when truthy
     * @returns {void}
     */
        ...
        return nylas.messages.list(nylasParams).then((response) => {
            ...
            if (!clonedParams.includeDrafts) {
                ...
                if (clonedParams.limit && response.length === clonedParams.limit && responseObject.messages.length < clonedParams.limit) {
                    const newLimit = clonedParams.limit - responseObject.messages.length;
                    const filterOptions = { ...options };

                    clonedParams.pageToken = (clonedParams.pageToken || clonedParams.limit) + newLimit;
                    clonedParams.limit = newLimit;
     ...
     * @param {Object} options
     * @param {Boolean} [options.raw] - If true the response will not be transformed to the unified object
     * @param {function(Error?, { files: Array.<Object>, next_page_token: String? }):void} callback Returns an array of unified file resources when options.raw is falsy or the raw response of the API when truthy
     *
     * @returns {void}
     */
     ...
     * @param {Boolean} [options.raw] If true the response will not be transformed to the unified object
     *
     * @param {function(Error, Object):void} callback  Returns a unified file resource when options.raw is falsy or the raw response of the API when truthy
     * @returns {void}
     */
     ...
     *
     * @returns {Array.<Object>} - Array of unified message resources
     */
     ...
     *
     * @returns {Array.<Object>} - Array of unified file resources
     */
