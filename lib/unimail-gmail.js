...
class GmailConnector extends EventEmitter {
    ...
    listMessages(auth, params, options, callback) {
        ...
        return this.refreshAuthCredentials(gmailParams.auth, (err, token) => {
            ...
            return Async.map(paramsArray, (gmailParam, callback) => {
                ...
                return this._callAPI(Gmail.users.messages.list, gmailParam, (err, listResponse) => {
    ...
    sendMessage(auth, params, options, callback) {
        ...
        return Utils.generateMessage(mailOptions, { base64Encoded: true }, (err, rawMessage) => {
            ...
            return this._callAPI(Gmail.users.messages.send, gmailSendParams, (err, sendResponse) => {
    ...
    _extractNonContainerParts(part) {
        ...
        if (part.parts && part.parts.length > 0) {
            ...
            // Flatten the array
            return [...part.parts.map((multipart) => {
