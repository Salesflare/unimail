...
class GmailConnector extends EventEmitter {
     ...
     *
     * @param {function(Error?, (Object | String)?)} callback Returns a unified message resource when options.raw is falsy or the raw response of the API when truthy
     * @returns {void}
     */
     ...
     *
     * @param {function(Error?, Object?):void} callback - Content of the attachment
     *
     * @returns {void}
     */
