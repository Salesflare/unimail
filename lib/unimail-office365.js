            ...
            return apiRoute.post(message)
                ...
                .catch((err) => {
                    ...
                    if (params.inReplyTo && err.statusCode === 400) {
                        return client.api('/me/messages').post(message).then((resultWithoutReply) => {

                            return client.api(`/me/messages/${resultWithoutReply.id}/send`).post({}).then(() => {
