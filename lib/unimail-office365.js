...
class Office365Connector extends EventEmitter {
     ...
     *
     * @returns {MessageResource | Object | String | null} Returns a unified message resource when options.raw is falsy or a raw response from the API when truthy.
     ...
     * @param {function} callback
     *
     * @returns {undefined} A big part of the uri string needed to make the API call
     */
