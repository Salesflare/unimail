...
class Office365Connector extends EventEmitter {
     ...
     * @param {Boolean} [options.raw] - If true the response will not be transformed to the unified object
     *
     * @param {function(Error, MessageListResource):void} callback - Returns an array of unified message resources when options.raw is falsy, or the raw response of the API when truthy
     *
     * @returns {void}
     */
     ...
     * @param {function(Error, Array.<MessageResource>):void} callback - Returns array of transformed messages or one message object if only one message was provided as parameter
     *
     * @returns {void}
     */
 ...
 *
 * @param {MicrosoftGraph.Client} client
 * @param {{ from: { email: String }, to: { email: String }, subject: String }} params
