...
class Office365Connector extends EventEmitter {
    ...
    sendMessage(auth, params, options, callback) {
        ...
        return Async.parallel({
            ...
            if (params.inReplyTo) {
                return internals.reply(message, hiddenUnimailGuid, params, client, callback);
            }

            return internals.sendMessage(message, hiddenUnimailGuid, params, client, callback);
        });
    }
...
internals.sendMessage = (message, hiddenUnimailGuid, params, client, callback) => {
...
internals.reply = (message, hiddenUnimailGuid, params, client, callback) => {
        ...
        .then((response) => {
            ...
            return client.api(`/me/messages/${response.id}`).patch(message)
                .then((updateResponse) => {
                    ...
                    return client.api(`/me/messages/${updateResponse.id}/send`).post({}).then(() => {
