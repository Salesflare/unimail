            ...
            return client.api(`/me/messages/${params.id}`)
                ...
                .then((resMessage) => {
                    ...
                    return this._transformMessages(resMessage, (err, transformedMessages) => {
                        ...
                        return client.api(`/me/messages/${transformedMessage.service_message_id}/attachments`).select('microsoft.graph.fileAttachment/contentId', 'microsoft.graph.fileAttachment/contentType', 'id', 'size', 'name', 'lastModifiedDateTime', 'isInline').get()
                            .then((resFiles) => {
